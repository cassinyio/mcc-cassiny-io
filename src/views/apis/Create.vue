    ...
    <div class="row">
      <div class="col-md-9">
        <b-card>
          ...
          <b-form-fieldset description="Give a short description about your api" label="Description" :label-cols="3" :horizontal="true">
            <b-form-input type="text" v-model="api.description"></b-form-input>
          </b-form-fieldset>
          ...
          <b-form-fieldset description="Select a cargo if you want to have a shared storage solution" label="Cargo" :label-cols="3" :horizontal="true">
            <b-form-select :plain="true" text-field="name" value-field="id" v-model="api.cargo_id" :options="user.cargos" value="Please select a cargo">
            </b-form-select>
          </b-form-fieldset>
          ...
          <b-form-fieldset description="Select the size of the machine you want to use" label="Machine" :label-cols="3" :horizontal="true">
            <b-form-radio :options="[
                  ...
                  ]" v-model="api.machine" value="1" stacked></b-form-radio>
          </b-form-fieldset>
...
export default {
  ...
  methods: {
    ...
    createApi () {
      this.$http.post('/spawner//apis', this.api)
        .then(response => {
          // JSON responses are automatically parsed.
